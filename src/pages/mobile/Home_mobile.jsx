...
export const Home_mobile = ({ card_items, event_items }) => {
    return (
        <>
            <div className='w-full h-full z-0'>
                ...
                <div className='flex justify-end text-white w-full bg-[url("/church_background.jpg")] bg-cover bg-top-left relative py-14 animate-fadeInBase'>
                    ...
                    <div className='relative mx-4 my-6 p-6 text-right flex flex-col gap-6'>
                        <div className='flex flex-col gap-2'>
                            <p className='text-xs font-semibold uppercase tracking-widest text-white/60'>Houston, TX</p>
                            <h1 className='font-bold text-3xl leading-tight'>Robertson SDA</h1>
                        </div>
                ...
                <div className='bg-[url("/wavy.png")] bg-cover bg-top-left'>
                    <div className='flex flex-col items-center py-12 px-6'>
                        <div className='max-w-2xl text-center flex flex-col gap-5'>
                            ...
                            <h1 className='text-2xl font-bold leading-tight'>Robertson Seventh-day Adventist Church</h1>
                ...
                <div className='bg-gray-100 py-16'>
                    <div className='max-w-6xl mx-auto flex flex-col gap-12 px-8'>
                        {card_items.map((item, idx) => (
                            <div key={idx} className='flex flex-col items-stretch gap-4'>
                                <div className='w-full shrink-0'>
                                    <img src={item.image} alt={item.title} className='w-full h-56 object-cover rounded shadow' />
                                </div>
                                <div className='flex flex-col justify-center bg-white p-8 flex-1'>
                                    <h2 className='px-3 text-2xl font-bold mb-2'>{item.title}</h2>
                ...
                <div className='py-8 w-full bg-linear-to-r/srgb from-blue-800 to-green-800'>
                    <div className='w-full h-full flex flex-col items-center p-8'>
                        <h3 className='text-white font-bold m-4 p-3 text-2xl'>Page Reference Here</h3>
