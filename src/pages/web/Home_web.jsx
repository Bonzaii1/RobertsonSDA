...
export const Home_web = ({ card_items, event_items }) => {
    return (
        <>
            <div className='w-full h-full z-0'>
                ...
                <div className='bg-white'>
                    <div className='flex flex-col items-center p-12'>
                        <h1 className='text-4xl font-bold p-4'>Our Services</h1>
                        <br />
                        <div className='mx-32 p-4 text-center'>
                ...
                <div className='bg-gray-100 py-16'>
                    <div className='max-w-6xl mx-auto flex flex-col gap-12 px-8'>
                        {card_items.map((item, idx) => (
                            <div key={idx} className={`flex flex-row items-stretch gap-10 ${idx % 2 !== 0 ? 'flex-row-reverse' : ''}`}>
                                <div className='w-100 shrink-0'>
                                    <img src={item.image} alt={item.title} className='w-full h-full object-cover rounded shadow' />
                                </div>
                                <div className='flex flex-col justify-center bg-white p-22 flex-1'>
                                    <h2 className='px-3 text-3xl font-bold mb-2'>{item.title}</h2>
                ...
                <div className='py-8 w-full bg-linear-to-r/srgb from-blue-800 to-green-800'>
                    <div className='w-full h-full flex flex-col items-center p-8'>
                        <h3 className='text-white font-bold m-4 p-3 text-4xl'>Page Reference Here</h3>
